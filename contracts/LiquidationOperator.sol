...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    constructor() {
        ...
        //debt_USDT = จำนวน USDC ที่ไปกู้มา
    ...
    function uniswapV2Call(
        ...
        console.log("-----------------------------------------------------------------");       //(uint256 reserve_WBTC_Pool2, uint256 reserve_WETH_Pool2, ) = uniswapV2Pair_WBTC_WETH.getReserves(); // Pool2
        ...
        console.log("debtToCover USDC: %s", debtToCover);
        console.log("reserve_WETH_Pool1: %s", reserve_WETH_Pool1);
        console.log("reserve_USDC_Pool1: %s", reserve_USDC_Pool1);
